...
public class AssignWF2OnlineDev {
	...
	public AssignWF2OnlineDev() throws SUPAdminException{
		...
		SUPMobileWorkflow mobileWorkflow = SUPObjectFactory.getSUPMobileWorkflow(AssignDeviceApp.mClusterContext);
		SUPApplication app = SUPObjectFactory.getSUPApplication(AssignDeviceApp.mClusterContext);
